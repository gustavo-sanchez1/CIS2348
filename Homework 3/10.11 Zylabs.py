...
class FoodItem:  # class name

    def __init__(self, name='None', fat=0.0, carbs=0.0, protein=0.0):  # constructor with parameters,initialize instances
        self.name = name
        self.fat = fat
        self.carbs = carbs
        self.protein = protein
    def get_calories(self, num_servings): # formula to get calories
        # Calorie formula
        calories = ((self.fat * 9) + (self.carbs * 4) + (self.protein * 4)) * num_servings;
        return calories
    def print_info(self): # nutritional information
...
if __name__ == "__main__":  # main code
    food_item1 = FoodItem()  # input items
    item_name = input()
